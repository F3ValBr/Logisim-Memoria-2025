...
import com.cburch.logisim.verilog.file.importer.VerilogJsonImporter;
...
public class ProjectCircuitActions {
    ...
    public static void doImportJsonVerilog(Project proj) {
        // Puedes conservar esta firma y delegar:
        CellFactoryRegistry registry = new CellFactoryRegistry();
        VerilogJsonImporter importer = new VerilogJsonImporter(registry);
        importer.importInto(proj);
    }
    // fin
